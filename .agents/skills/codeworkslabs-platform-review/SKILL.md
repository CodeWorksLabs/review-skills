...
- Discourse plugin, theme, theme component, or integration: read the complete structured core [references/platforms/discourse/DiscourseSkill.improved.json](references/platforms/discourse/DiscourseSkill.improved.json), the complete working Markdown skill [references/platforms/discourse/DiscourseSkill.md](references/platforms/discourse/DiscourseSkill.md), and [references/platforms/discourse/PROVENANCE.md](references/platforms/discourse/PROVENANCE.md). The JSON supplies the active extension-type routing, evidence thresholds, modes, release policy, and report contract; the Markdown preserves the complete numbered review method. Neither is optional or replaceable by a summary.
